 ...
 * 
 */
public class RingAnimtionFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=5" + "&pi="
