 ...
 * 
 */
public class TVSubFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		// }else{
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=4" + "&pi="
	...
	public void setStyle(CusPullListView listview2) {
		...
		musiclandtitle.setText(R.string.popular_tv);
	...
	public void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		MobclickAgent.onPageStart("TV"); //统计页面
	}
