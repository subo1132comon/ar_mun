package com.byt.market.mediaplayer.MV;
...
public class MVActivity extends FragmentActivity implements
		OnPageChangeListener, OnClickListener {

	private View recArea;
	AlwsydMarqueeTextView tv_title;
	public MVSubFragment homeFragment;
	public RingMVFragment homeFragment2;
	...
	private void initPaper() {
		...
		homeFragment = new MVSubFragment();
		homeFragment2 = new RingMVFragment();
		fragmentList.clear();
	...
	private void initView() {
		try {
			...
			//findViewById(R.id.ringbottom).setVisibility(View.GONE);
			...
			buttonringhome.setText(getString(R.string.mmv));
			buttonringrank.setText(getString(R.string.mv));
	...
	public void onClick(View view) {
		try {
			...
			case R.id.top_downbutton:
				MobclickAgent.onEvent(this, "MVdownmang");
				StatService.trackCustomEvent(this, "MVdownmang", "");
	...
	protected void onDestroy() {
		super.onDestroy();
		StatService.trackCustomEndEvent(this, "mv", "");
		try {
		...
		MobclickAgent.onEventValue(this, "MV", null,endtime/1000);
		Log.d("nnlog", "统计MV---"+endtime/1000);
	}

	@Override
	protected void onStart() {
		// TODO Auto-generated method stub
		StatService.trackCustomBeginEvent(this, "mv", "");
		super.onStart();
	}
	@Override
...
//		if(!RapitUtile.queayTime()){
//			RapitUtile.setTimeYes(true);
//		}
	}
	@Override
