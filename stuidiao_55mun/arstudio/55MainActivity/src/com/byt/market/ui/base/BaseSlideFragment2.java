...
/**
 * 可滑动的基础框架Fragment,其中TAB是动态去添加的
 */
public abstract class BaseSlideFragment2 extends BaseUIFragment implements
		ActivityInit {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = (ViewGroup) inflater.inflate(getResLayoutId(), container,
				false);
		initView();
		initData();
		return rootView;
	}
	public void initViewBYT(){
		
	}
	@Override
	public void initView() {
		initViewBYT();
		viewPager = (ControlScrollViewPager) rootView
	...
	protected static class TabsAdapter extends FragmentPagerAdapter implements
		...
		public void onPageSelected(int position) {
			...
			for (int i = 0; i < getCount(); i++) {
				...
				View tabline=tabView.findViewById(R.id.tab_line1);
		...
		public void initViewPagerAdapter(List<BaseFragment> list) {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				TabView tabview = new TabView(R.layout.top_viewpager_tab_item2,
						mInflater);
