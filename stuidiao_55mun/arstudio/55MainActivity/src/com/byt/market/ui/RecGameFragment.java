 ...
 * 月排行
 */
public class RecGameFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		return Constants.LIST_URL + "?qt=" + Constants.GAME_REC + "&pi="
					...
					/* add by zengxiao for change UI */
						...
						//	itemHolder.share_icon.setVisibility(View.VISIBLE);
							...
							public void onClick(View arg0) {
								...
								if(itemHolder.downBtn2.getText().toString().equals(RecGameFragment.this.getActivity().getString(R.string.sharedown)))
								{
									Intent intent =new Intent();
									intent.setClass(RecGameFragment.this.getActivity(),ShareActivity.class);						
									intent.putExtra("sendstring", appItem); 
									RecGameFragment.this.getActivity().startActivity(intent);
								}
								else
								{
							...
							if(!imageLoader.getPause().get()){
								Drawable drawable=RecGameFragment.this.getActivity().getResources().getDrawable(R.drawable.progress_listitem);
