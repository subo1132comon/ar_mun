...
public class NewsTextImageFragment extends ListViewFragment{
	...
	protected String getRequestUrl() {
		...
		//if(urlIndex == 0){
			 u = Constants.APK_URL+"Joke/v1.php?qt=Jokelist&cid=4"+"&pi="
					    ...
					    + getPageInfo().getPageSize()+"&stype="+MainActivity.NEWS_KEY;
		//}
//		if(urlIndex == 1){
//			u = Constants.APK_URL+"Joke/v1.php?qt=Jokelist&cid=4"+"&pi="
//				    + getPageInfo().getNextPageIndex() + "&ps="
...
//                    break;
	...
	private class CollectScoreTaskListener implements TaskListener {
		...
		public void onNetworkingError() {
			showShortToast(NewsTextImageFragment.this.getActivity().getString(R.string.rastar_neterror));
		}
	...
	private class MybigicLisenler implements OnClickListener{
		...
		public void onClick(View arg0) {
			...
			MobclickAgent.onEvent(getActivity(), "newsItem");
			StatService.trackCustomEvent(getActivity(), "newsItem", "");
...
//			if(mtype.equals("gif")){
//				Intent intent = new Intent(NewsTextImageFragment.this.getActivity(),PlayGifActivity.class);
//				Bundle bundle = new Bundle();
//				bundle.putString("joke_image_path", murl);
//				bundle.putInt("sid", mcaItem.sid);
//				intent.putExtras(bundle);			
//				NewsTextImageFragment.this.getActivity().startActivity(intent);
//			}else if(mtype.equals("mp4")){
//				Intent pintent = new Intent(NewsTextImageFragment.this.getActivity(), HtmlTVpalyActivity.class);
//				Bundle bundle = new Bundle();
//				bundle.putString("url", murl);
//				bundle.putInt("sid", mcaItem.sid);
//				pintent.putExtras(bundle);
//				NewsTextImageFragment.this.getActivity().startActivity(pintent);
//			}else{
