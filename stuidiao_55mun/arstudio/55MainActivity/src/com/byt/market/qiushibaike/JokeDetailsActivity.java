...
public class JokeDetailsActivity extends Activity implements OnClickListener ,ScrollViewListener{
	...
	private void initView(Bundle bundle) {
		...
		if(hasTime(bundle.getString("title"))&&time>0){
					...
					if (type.toString().equals("gif")) {
						...
						textviewbyt.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View arg0) {
								...
								int id=arg0.getId();
								Intent intent = new Intent(JokeDetailsActivity.this,PlayGifActivity.class);
