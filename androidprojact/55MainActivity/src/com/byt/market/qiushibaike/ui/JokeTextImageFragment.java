...
public class JokeTextImageFragment extends ListViewFragment{
...
//		});
        ...
        public View newView(LayoutInflater inflater, BigItem item) {
            ...
            switch(item.layoutType){
                case BigItem.Type.LAYOUT_CAEGORYLIST:
                    ...
                    //add by bobo
                    itemHolder.time_tv = (TextView) view.findViewById(R.id.joketime);
                    itemHolder.title_tv = (TextView) view.findViewById(R.id.joketile);
                    //add end===
            ...
            switch (item.layoutType){
                case BigItem.Type.LAYOUT_CAEGORYLIST:
                    ...
                    {	
                       ...
                       // jokeTextImageHolders.get(i).title_tv.setText(getTitle(cateItem.cTitle));
                      //  String contentres = "";
                      ...
                      //  jokeTextImageHolders.get(i).content.setText(cateItem.cTitle);
						...
						if(contentstring!=null&&contentstring.trim().length()>0)
						{
							...
							if(!contentstring.equals(""))
							{
								int start=0;
								int end=0;
								TextView textview=new TextView(JokeTextImageFragment.this.getActivity());
								GifDecoderView gif=new GifDecoderView(JokeTextImageFragment.this.getActivity());
                        ...
                        jokeTextImageHolders.get(i).comment.setOnClickListener(new OnClickListener() {			
                			...
                			public void onClick(View view) 
                			{
                				...
                				joke_comment(cate);
                				NotifaHttpUtil.shareHttp(Constants.SHREA_PATH+cate.sid+".html");
                			}
                		});
	...
	private class CollectScoreTaskListener implements TaskListener {
		...
		public void onNetworkingError() {
			showShortToast(JokeTextImageFragment.this.getActivity().getString(R.string.rastar_neterror));
		}
	...
	private class MylayoutLisenler implements OnClickListener{
		...
		public void onClick(View arg0) {
			...
			if(mtype.equals("gif")){
				//NotifaHttpUtil.shareHttp(Constants.SHREA_PATH+mcaItem.sid+".html");
				Intent intent = new Intent(JokeTextImageFragment.this.getActivity(),PlayGifActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("joke_image_path", murl);
				bundle.putInt("sid", mcaItem.sid);
				intent.putExtras(bundle);			
				JokeTextImageFragment.this.getActivity().startActivity(intent);
			}else if(mtype.equals("mp4")){
				//NotifaHttpUtil.shareHttp(Constants.SHREA_PATH+mcaItem.sid+".html");
				Intent pintent = new Intent(JokeTextImageFragment.this.getActivity(), HtmlTVpalyActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("url", murl);
				bundle.putInt("sid", mcaItem.sid);
				pintent.putExtras(bundle);
				JokeTextImageFragment.this.getActivity().startActivity(pintent);
			}else{
