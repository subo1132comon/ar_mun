...
public class NewsActivity extends FragmentActivity implements OnPageChangeListener, OnClickListener {
	private static final String TAG = "JokeActivity";
	private AlwsydMarqueeTextView tv_title;
	//, button_joke_text
	private LinearLayout jokebottomlinlayout;
    ...
    private NewsTextImageFragment jokeTextImageFragment;
   ...
   // private RelativeLayout qiushilayout;//糗事百科布局
	...
	protected void onCreate(Bundle arg0) {
		...
		if(getIntent().getStringExtra("notif")!=null){
			...
			editor.putInt(MainActivity.NEWS_KEY, 1);
			editor.commit();
		}
		initView();
		initPager();
	...
	private void initView()
	{
		try {
			...
			jokebottomlinlayout = (LinearLayout) findViewById(R.id.jokebottom);
			jokebottomlinlayout.setVisibility(View.GONE);
	...
	private void initPager()
	{
		...
		jokeTextImageFragment = new NewsTextImageFragment();
...
//		}		
	...
	private void createDatebase()
	{
		...
		JokeDataDatabaseHelper dbHelper = JokeDataDatabaseHelper.getInstance(NewsActivity.this);
	...
	protected void onResume() {
		...
		StatService.trackCustomBeginEvent(this, "news", "");
	}
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		StatService.trackCustomEndEvent(this, "news", "");
		int endtime = (int) (System.currentTimeMillis()-umtime);
		MobclickAgent.onEventValue(this, "News", null,endtime/1000);
	}
}
