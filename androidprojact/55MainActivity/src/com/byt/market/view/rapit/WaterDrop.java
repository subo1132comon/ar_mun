package com.byt.market.view.rapit;

import com.byt.market.view.rapit.DropCover.OnDragCompeteListener;
...
public class WaterDrop extends RelativeLayout {
    ...
    public void setOnDragCompeteListener(OnDragCompeteListener onDragCompeteListener) {
        mOnDragCompeteListener = (OnDragCompeteListener) onDragCompeteListener;
    }
}
