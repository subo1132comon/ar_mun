...
public class MyMoneyDailog extends Dialog implements android.view.View.OnClickListener{
	...
	private TextView m_day,m_moth,m_year;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_day = (TextView) findViewById(R.id.day);
		m_moth = (TextView) findViewById(R.id.moth);
		m_year = (TextView) findViewById(R.id.year);
...
//		mvalues.setText(String.valueOf(money)+" "+"THB");
		...
		String day = String.valueOf(df.format(Double.parseDouble(mpriceday)/7));
		String moth = String.valueOf(df.format(Double.parseDouble(mpricemonth)/60));
		String year = String.valueOf(df.format(Double.parseDouble(mpriceyear)/365));
		
		m_day.setText("("+day+"฿/"+mcontext.getString(R.string.dan)+")");
		m_moth.setText("("+moth+"฿/"+mcontext.getString(R.string.dan)+")");
		m_year.setText("("+year+"฿/"+mcontext.getString(R.string.dan)+")");
