...
import com.byt.market.ui.CateMainFragment.MyFragmentPagerAdapter;
import com.byt.market.ui.RankMonthFragment;
import com.byt.market.ui.RecAppFragment;
import com.byt.market.ui.base.BaseFragment;
import com.byt.market.ui.base.BaseSlideFragment;
import com.byt.market.ui.base.BaseSlideFragment2;
import com.byt.market.ui.base.BaseUIFragment;

/**
 * 应用总页面 
 */
public class RankMainFragmentActivity extends FragmentActivity implements OnClickListener, OnPageChangeListener {
	private View recArea, cateArea,rankArea;
	private CateFragment cateFragment;
	private RecAppFragment recFragment;
	private RankMonthFragment rankFragment;
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(R.layout.cate_main_fragment);
		initView();
		initPaper();
	}
	...
	private void initPaper() {
		 mPager = (ViewPager)findViewById(R.id.viewpager);  
			...
			recFragment = new RecAppFragment();
			rankFragment=new RankMonthFragment();
			fragmentList.clear();
	...
	private void initView() {
		try {
			...
			buttonrec=(Button) findViewById(R.id.bt_rec_button);
			buttonrec.setSelected(true);
			buttonrec.setOnClickListener(this);
			buttoncate=(Button) findViewById(R.id.bt_cate_button);
			buttoncate.setOnClickListener(this);
			buttonrank=(Button) findViewById(R.id.bt_rank_button);
			buttonrank.setOnClickListener(this);
			recArea = findViewById(R.id.game_rec_area);
			tab_line2= findViewById(R.id.cate_tab_line2);
			tab_line1= findViewById(R.id.cate_tab_line1);
			tab_line3= findViewById(R.id.cate_tab_line3);
