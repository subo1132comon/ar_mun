 ...
 * 
 */
public class AnimtionSubFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		// }else{
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=6" + "&pi="
				+ getPageInfo().getNextPageIndex() + "&ps="
				+ getPageInfo().getPageSize()+"&stype="+MainActivity.ANIME_KEY;
		// }
	}
	...
	public void onResume() {
		...
		super.onResume();
		MobclickAgent.onPageStart("动画"); //统计页面
	}
	@Override
	public void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		MobclickAgent.onPageEnd("动画"); 
	}
	@Override
