...
public class NewRingActivity extends FragmentActivity implements
		OnPageChangeListener, OnClickListener {

	private View recArea;
	AlwsydMarqueeTextView tv_title;
	public MusicSubFragment homeFragment;
	public RingFragment homeFragment2;
	...
	private void initPaper() {
		...
		homeFragment = new MusicSubFragment();
		homeFragment2 = new RingFragment();
		fragmentList.clear();
	...
	private void initView() {
		try {
			...
			tv_title.setText(R.string.music_string);
	...
	public void onClick(View view) {
		try {
			...
			case R.id.top_downbutton:
				...
				MobclickAgent.onEvent(this, "MusicDownmang");
				StatService.trackCustomEvent(this, "MusicDownmang", "");
...
//						String logurl = pref.getString("logoUrl", "");//如果没有，默认为"" 
//						LogCart.Log("传过来的地址--"+logurl);
//						 imageLoader.displayImage("icons/201603/11/fc85/56e236b77d922.png", playBaricon, mOptions);
					}
					musicName.setText(service.getCurMusicName());
					musicAuthor.setText(service.getCurMusicAuthor());
					refreshPlayStateIcon();
	...
	protected void onStart() {
		// TODO Auto-generated method stub
		super.onStart();
		StatService.trackCustomBeginEvent(this, "music", "");
	}
	
	@Override
	protected void onDestroy() {
		super.onDestroy();
		StatService.trackCustomEndEvent(this, "music", "");
		try {
		...
		MobclickAgent.onEventValue(this, "Music", null,endtime/1000);
		Log.d("nnlog", "统计Music-----"+endtime/1000);
	}
