 ...
 * 
 */
public class ShowSubFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		// }else{
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=12" + "&pi="
				+ getPageInfo().getNextPageIndex() + "&ps="
				+ getPageInfo().getPageSize()+"&stype="+MainActivity.SHOW_KEY;
		// }
	}
	...
	public void setStyle(CusPullListView listview2) {
		...
		//musiclandtitle.setVisibility(View.GONE);
		musiclandtitle.setText(R.string.popular_animotion);
