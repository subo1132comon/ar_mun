 ...
 * 
 */
public class MusicSubFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		// }else{
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=2" + "&pi="
	...
	public void setStyle(CusPullListView listview2) {
		...
		musiclandtitle.setText(R.string.allmusicsub);
