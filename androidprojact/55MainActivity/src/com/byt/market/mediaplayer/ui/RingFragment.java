 ...
 * 
 */
public class RingFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=1" + "&pi="
				...
				+ getPageInfo().getPageSize()+"&stype="+MainActivity.MUSIC_KEY;
	...
	public void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		MobclickAgent.onPageStart("音乐排行");
	}
