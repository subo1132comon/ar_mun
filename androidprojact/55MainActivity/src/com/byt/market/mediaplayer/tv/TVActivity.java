...
public class TVActivity extends FragmentActivity implements
		OnPageChangeListener, OnClickListener {

	private View recArea;
	AlwsydMarqueeTextView tv_title;
	public TVSubFragment homeFragment;
	public RingTVFragment homeFragment2;
	...
	private void initPaper() {
		...
		homeFragment = new TVSubFragment();
		homeFragment2 = new RingTVFragment();
		fragmentList.clear();
	...
	public void onClick(View view) {
		try {
			...
			case R.id.top_downbutton:
				...
				MobclickAgent.onEvent(this, "TVDownmang");
				StatService.trackCustomEndEvent(this, "TVDownmang", "");
	...
	protected void onDestroy() {
		super.onDestroy();
		StatService.trackCustomEndEvent(this, "TV", "");
		try {
		...
		MobclickAgent.onEventValue(this, "TV", null,endtime/1000);
		Log.d("nnlog", "统计TV");
	...
	protected void onStart() {
		// TODO Auto-generated method stub
		StatService.trackCustomBeginEvent(this, "TV", "");
		super.onStart();
	}
	@Override
