 ...
 * 音乐下载管理
 */
public class MusicDownLoadManageActivity extends FragmentActivity implements OnPageChangeListener, OnClickListener  {


	private View recArea;
	AlwsydMarqueeTextView tv_title;
	private MusicDownedFragment homeFragment;
	...
	private void initPaper() {
		 ...
		 mPager = (ViewPager)findViewById(R.id.ringviewpager);  
	        ...
	        homeFragment = new MusicDownedFragment();
	...
	private void initView() {
		try {
			...
			buttonringhome.setText(R.string.downloading_title_desc);
			buttonringrank=(Button) findViewById(R.id.ring_rank_button);
			buttonringrank.setText(R.string.downloaded_title_desc);
