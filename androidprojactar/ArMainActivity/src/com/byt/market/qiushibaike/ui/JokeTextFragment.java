...
public class JokeTextFragment extends ListViewFragment{
	...
	protected String getRequestUrl() {
		return Constants.APK_URL+"Joke/v1.php?qt=Jokelist&cid=1"+"&pi="
                ...
                /////////----------------------------
						...
						if(contentstring!=null&&contentstring.trim().length()>0)
						{
							...
							if(!contentstring.equals(""))
							{
								...
								int end=0;
								String textstring="";
								TextView textview=new TextView(JokeTextFragment.this.getActivity());
								...
								if(contentstring.startsWith("<img src="))
								{
									...
									if(contentstring.startsWith("<iframe")){
	...
	private class CollectScoreTaskListener implements TaskListener {
		...
		public void onNetworkingError() {
			showShortToast(JokeTextFragment.this.getActivity().getString(R.string.rastar_neterror));
		}
	...
	private class MylayoutLisenler implements OnClickListener{
		...
		public void onClick(View arg0) {
			...
			if(mtype.equals("gif")){
				Intent intent = new Intent(JokeTextFragment.this.getActivity(),PlayGifActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("joke_image_path", murl);
				intent.putExtras(bundle);			
				JokeTextFragment.this.getActivity().startActivity(intent);
			}else if(mtype.equals("mp4")){
				Intent pintent = new Intent(JokeTextFragment.this.getActivity(), HtmlTVpalyActivity.class);
				pintent.putExtra("url", murl);
				JokeTextFragment.this.getActivity().startActivity(pintent);
			}else{
