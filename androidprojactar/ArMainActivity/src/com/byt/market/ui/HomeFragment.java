	...
	private class HomeAdapter extends ImageAdapter {
		...
		public View newView(LayoutInflater inflater, BigItem item) {
			...
			case BigItem.Type.LAYOUT_LEADER_THREE:
				...
				//糗百
				homeLeaderHolder.leadericons[2] = (WaterDrop) view
						.findViewById(R.id.fun_redpoint_tv);
				homeLeaderHolder.leadernames[2] = (TextView) view
						.findViewById(R.id.listitem_leader_three_name_1);
				homeLeaderHolder.leaderviews[2] = view
						.findViewById(R.id.listitem_leader_three_view_1);
				resUpdate(homeLeaderHolder.leadericons[2], MainActivity.JOKE_KEY);
				//tv
				...
				//av
				homeLeaderHolder.leadericons[8] = (WaterDrop) view
				...
				homeLeaderHolder.leaderviews[8] = view
						.findViewById(R.id.listitem_leader_three_view_4);
				resUpdate(homeLeaderHolder.leadericons[8], MainActivity.AV_KEY);
...
//				homeLeaderHolder.leaderviews[9] = view.findViewById(R.id.listitem_leader_three_Voiced_icon_1);
				...
				//6---2动画
				homeLeaderHolder.leadericons[5] = (WaterDrop) view.findViewById(R.id.anim_redpoint_tv);
				homeLeaderHolder.leaderviews[5] = view.findViewById(R.id.listitem_leader_three_anime);
...
//								.setImageResource(R.drawable.app_empty_icon);
			...
			case BigItem.Type.LAYOUT_LEADER_THREE:
					...
					for (int i = 0; i < 9
						...
						//是否显示 av
						if(MyApplication.getInstance().getUser().getVIP() == 1){
							if(index == 7){
								leaderHolder.leaderviews[index].setVisibility(View.GONE);
							}
							if(index == 8){
								leaderHolder.leaderviews[index].setVisibility(View.VISIBLE);
							}
						}
