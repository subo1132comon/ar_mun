...
public abstract class CateListViewFragment extends BaseUIFragment implements
...
//			imageLoader.clearDiscCache();
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		boolean isBottom = firstVisibleItem + visibleItemCount == totalItemCount
				...
				Log.d("myzx", "mAdapter.getPageInfo().getPageIndex() ="+mAdapter.getPageInfo().getPageIndex() +
						"mAdapter.getPageInfo().getPageNum()="+mAdapter.getPageInfo()
					.getPageNum());
