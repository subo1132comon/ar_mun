 ...
 * 游戏排行
 */
public class RankMonthFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		return Constants.LIST_URL + "?qt=" + Constants.APP_RANK + "&pi="
					...
					if(appItem.isshare==1){
						...
						itemHolder.downBtn2.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View arg0) {
								...
								if(itemHolder.downBtn2.getText().toString().equals(RankMonthFragment.this.getActivity().getString(R.string.sharedown)))
								{
									Intent intent =new Intent();
									intent.setClass(RankMonthFragment.this.getActivity(),ShareActivity.class);						
						...
						if(!imageLoader.getPause().get()){
							Drawable drawable=RankMonthFragment.this.getActivity().getResources().getDrawable(R.drawable.progress_listitem);
