...
public class CustomScreenScrollLayout extends ViewGroup {
	...
	public CustomScreenScrollLayout(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init(context);
	}

	public CustomScreenScrollLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init(context);
	}
	...
	public void snapToScreen(int whichScreen) {
		...
		if (getScrollX() != (whichScreen * getWidth())) {
			...
			mScroller.startScroll(getScrollX(), 0, whichScreen * getWidth()
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		try{
		viewPager.requestDisallowInterceptTouchEvent(true);// 这个是为了解决与ViewPager之间的冲突问题
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (MotionEvent.ACTION_UP==action&&Math.abs(firstX - (int) x) < 20 && Math.abs(firstY - (int) y) < 20
				&& !MarketContext.getInstance().isGalleryMove) {
			Message msg = new Message();
			msg.what = 1228;
			msg.arg1 = mCurScreen;
			mmHandler.sendMessage(msg);
