...
//	public static final int TEXT_ALIGN_CENTER            = 0x00000000;
	...
	public static final int TEXT_ALIGN_BOTTOM_WITHOUT_PADDING            = 0x01000000;
	...
	private void setTextLocation() {
		...
		switch (textAlign) 
		{
		case TEXT_ALIGN_BOTTOM_WITHOUT_PADDING:
			textCenterX = textWidth / 2;
			textBaselineY = viewHeight - (fm.bottom - fm.descent);
			break;
