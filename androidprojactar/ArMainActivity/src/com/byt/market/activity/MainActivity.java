	...
	public void initView() {
		...
		findViewById(R.id.test).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				//PayssionConfig.enablePM("cashu|onecard|bitcoin");
				double amount = 1;
	              String currency = "USD";
	             // String ref = "";
	              Intent intent = new Intent(MainActivity.this,
	              ...
	              intent.putExtra(
	                      ...
	                      new PayRequest()
			                      ...
			                      .setAPIKey("49f2b3ef86fe541a")//Your API Key
			                      .setAmount(amount)
			                     // .setPMId("cashu")
			                      .setCurrency(currency)
			                      .setDescription("Payment")
			                      .setOrderId("444412345987654321")// your order id
			                      .setSecretKey("a5a9a27772e68cd6738732fe53b5fcf2")
...
//			}
	...
	private void yuleVersionRead() {
		...
		// getHeader());
		task.execute(Constants.JOKE_COMMENT_URL+"?qt=Category1"
