...
//	public static final String IMG_URL = "http://ksfile.client.gamebean.net/";		//线上资源正式环境
	public static  String APK_URL = "http://ar.55mun.com:8022/";    //线上资源测试环境
	public static  String IMG_URL = "http://ar.55mun.com:8022/";	//线上资源测试环境
	...
	public static  String LIST_URL = "http://ar.55mun.com:8022/v1.php";// / 测试内网
	public static  String JOKE_COMMENT_URL = "http://ar.55mun.com:8022/Joke/v1.php";// / 糗百评论
	//新闻 糗百
	//joke.ar.55mun.com
	public static  String NEWS_JOKE_WEBBASE = "http://joke.ar.55mun.com";
	//音乐视频类分享
	public static  String MUSIC_TV_WEBBASE = "http://music.ar.55mun.com";
	// public static final String LIST_URL =
	...
	//public static  String YULE_VER_URL = "http://ar.55mun.com:8022/Joke/v1.php?qt=Category"; // 娱乐版块版本号查询	
	public static  String YULE_VER_URL = "http://ar.55mun.com:8022/Joke/v1.php?qt=Category1"; // 娱乐版块版本号查询	//add  by bobo
	public static  String BAK_LIST_URL = "http://ar.55mun.com:8022/v1.php"; // 备用url
	...
	//首页TV列表
	public static String TV_LIST_URL = "http://23.248.162.14:8022/";
	...
	public static void switchIP(){
		APK_URL="http://23.248.162.14:8022/";
		IMG_URL ="http://23.248.162.14:8022/";
		LIST_URL = "http://23.248.162.14:8022/v1.php";
		YULE_VER_URL = "http://23.248.162.14:8022/Joke/v1.php?qt=Category"; // 娱乐版块版本号查询	
		JOKE_COMMENT_URL = "http://23.248.162.14:8022/Joke/v1.php";// / 糗百评论
	}
	public static void initIP(){
		APK_URL="http://ar.55mun.com:8022/";
		IMG_URL ="http://ar.55mun.com:8022/";
		LIST_URL = "http://ar.55mun.com:8022/v1.php";
		YULE_VER_URL = "http://ar.55mun.com:8022/Joke/v1.php?qt=Category"; // 娱乐版块版本号查询	
		JOKE_COMMENT_URL = "http://ar.55mun.com:8022/Joke/v1.php";// / 糗百评论
	}
