package com.byt.market.mediaplayer.animtion;
...
public class AnimtionActivity extends FragmentActivity implements
		OnPageChangeListener, OnClickListener {

	private View recArea;
	AlwsydMarqueeTextView tv_title;
	public AnimtionSubFragment homeFragment;
	public RingAnimtionFragment homeFragment2;
	...
	private void initPaper() {
		...
		homeFragment = new AnimtionSubFragment();
		homeFragment2 = new RingAnimtionFragment();
		fragmentList.clear();
	...
	private void initView() {
		try {
			...
			tv_title.setText(R.string.cartoon);
	...
	protected void onDestroy() {
		...
		MobclickAgent.onEventValue(this, "Animtion", null,endtime/1000);
	}
	...
	protected void onResume() {
		...
		refreshPlayStateIcon();
	    MobclickAgent.onResume(this);//时长 
