 ...
 * 
 */
public class RingMVFragment extends ListViewFragment {
	...
	protected String getRequestUrl() {
		...
		// }else{
//		String u = Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=14" + "&pi="
//				+ getPageInfo().getNextPageIndex() + "&ps="
//				+ getPageInfo().getPageSize()+"&stype="+MainActivity.MV_KEY;
//		Log.d("nnlog", "----vvuu--"+u);
		
		
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=13" + "&pi="
		+ getPageInfo().getNextPageIndex() + "&ps="
		+ getPageInfo().getPageSize()+"&stype="+MainActivity.MV_KEY;
	...
	public void setStyle(CusPullListView listview2) {
		...
		musiclandtitle.setText(R.string.txt_home_leader_latest_collection);
		//musiclandtitle.setText("咳咳咳咳咳咳咳咳");
