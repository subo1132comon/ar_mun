 ...
 * 列表分类详情
 */
public class NewVoicedListInfoFrame extends BaseActivity implements
	...
	public NewVoicedListFragment cateListFragment;
...
//				if(cate.isNotif){
//					//腾讯
//					StatService.trackCustomEvent(getApplicationContext(),"Notification", "");
//				}
				...
				cateListFragment = new NewVoicedListFragment();
				bundle.putString("hot", Constants.CATE_HOT);
