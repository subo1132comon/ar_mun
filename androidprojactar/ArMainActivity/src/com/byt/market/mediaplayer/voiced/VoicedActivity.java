...
public class VoicedActivity extends FragmentActivity implements
		OnPageChangeListener, OnClickListener {

	private View recArea;
	AlwsydMarqueeTextView tv_title;
	public VoicedSubFragment homeFragment;
	public RingVoicedFragment homeFragment2;
...
//			}
	...
	private void initPaper() {
		...
		homeFragment = new VoicedSubFragment();
		homeFragment2 = new RingVoicedFragment();
		fragmentList.clear();
	...
	private void initView() {
		try {
			...
			tv_title.setText(R.string.novel);
	...
	public void onClick(View view) {
		try {
			...
			case R.id.top_downbutton:
				MobclickAgent.onEvent(this, "Noveldownmang");
				Intent downloadIntent = new Intent(this,
						VoicedDownLoadManageActivity.class);
...
//			}
	...
	protected void onDestroy() {
		...
		MobclickAgent.onEventValue(this, "Novel", null,endtime/1000);
		Log.d("nnlog", "统计Novel");
	}
	...
	protected void onResume() {
		...
		refreshPlayStateIcon();
		MobclickAgent.onPageStart("小说"); //统计页面
