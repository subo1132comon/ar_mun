 ...
 * 
 */
public class VoicedSubFragment extends ListViewFragment {
...
//		String url = Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=10" + "&pi="
//				+ getPageInfo().getNextPageIndex() + "&ps="
//				+ getPageInfo().getPageSize();
		
		return Constants.APK_URL + "Music/v1.php?qt=Ranklist&type=10" + "&pi="
				+ getPageInfo().getNextPageIndex() + "&ps="
