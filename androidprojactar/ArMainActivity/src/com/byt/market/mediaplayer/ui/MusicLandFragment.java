 ...
 *
 */
public class MusicLandFragment extends ListViewFragment {
...
//    	}else{
    	Log.d("myzx", Constants.LIST_URL + "?qt=" + Constants.CATE+"&ctype=app"+ "&pi="
    				+ getPageInfo().getNextPageIndex() + "&ps="
    				+ getPageInfo().getPageSize());
    		return Constants.APK_URL+"Music/v1.php?qt=Ranklist&type=1"+"&pi="
			+ getPageInfo().getNextPageIndex() + "&ps="
			+ getPageInfo().getPageSize();
...
//    		mImageFetcher.setLoadingImage(R.drawable.app_empty_icon);
    	...
    	mOptions = new DisplayImageOptions.Builder().showStubImage(R.drawable.default_disc_180)
		.cacheOnDisc().delayBeforeLoading(20).build();
    }
        ...
        public View newView(LayoutInflater inflater, BigItem item) {
            ...
            switch(item.layoutType){
                case BigItem.Type.LAYOUT_CAEGORYLIST:
                    ...
                    itemHolder1.icon=(ImageView) view.findViewById(R.id.musicrankicon);
                    ...
                    itemHolder1.musicHolder=(TextView) view.findViewById(R.id.musiclayout);
                    ...
                    ArrayList<CategoryItemHolder> cateHolders = holder.cateHolders;            
                        ...
                        if(cateItem.cDesc!=null)
                       {
                        ...
                        if (TextUtils.isEmpty(cateItem.ImagePath)) {
                            cateHolders.get(0).icon.setImageResource(R.drawable.default_disc_180);
                        }  else if(!imageLoader.getPause().get()){
                     	   //imageLoader.displayImage(cateItem.ImagePath, cateHolders.get(0).icon, mOptions);   
                     	   }     
                        cateHolders.get(0).musicHolder.setOnClickListener(new OnClickListener() {
							
							@Override
							public void onClick(View v) {
								onAppClick(cateItem, Constants.TOMusicLIST);
							}
						});
                    /*}*/
                    break;
