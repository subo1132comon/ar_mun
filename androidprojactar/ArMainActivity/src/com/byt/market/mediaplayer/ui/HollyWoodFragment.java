 ...
 *
 */
public class HollyWoodFragment extends ListViewFragment {
...
//    	}else{
    	return Constants.APK_URL+"Video/v1.php?qt=videolist&cid=2"+"&pi="
                       ...
                       {                   	 
                        ...
                        cateHolders.get(i).layout.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								intent.setClass(HollyWoodFragment.this.getActivity(),PlayActivity.class);						
								intent.putExtra("sendstring", cateItem); 
								HollyWoodFragment.this.getActivity().startActivity(intent);
							}
						});
                    }
                    /*}*/
