package com.byt.market.mediaplayer.show;
...
public class ShowActivity extends FragmentActivity implements
		OnPageChangeListener, OnClickListener {

	private View recArea;
	AlwsydMarqueeTextView tv_title;
	public ShowSubFragment homeFragment;
	//public RingShowFragment homeFragment2;
	...
	private void initPaper() {
		...
		homeFragment = new ShowSubFragment();
		//homeFragment2 = new RingShowFragment();
		fragmentList.clear();
	...
	private void initView() {
		try {
			...
			tv_title.setText(R.string.zongyi_string);
	...
	public void onClick(View view) {
		try {
			...
			case R.id.top_downbutton:
				...
				MobclickAgent.onEvent(this, "Showdownmang");
				StatService.trackCustomEvent(this, "Showdownmang", "");
...
//	}
	...
	protected void onDestroy() {
		super.onDestroy();
		StatService.trackCustomEndEvent(this, "Cartoon", "");
		try {
		...
		MobclickAgent.onEventValue(this, "Show", null,endtime/1000);
	}

	@Override
	protected void onStart() {
		// TODO Auto-generated method stub
		StatService.trackCustomBeginEvent(this, "Cartoon", "");
		super.onStart();
	}
	@Override
